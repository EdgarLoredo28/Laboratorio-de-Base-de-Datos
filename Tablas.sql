...
/****** Object:  Database [Hoy]    Script Date: 14/10/2017 10:22:22 a.m. ******/
CREATE DATABASE [Hoy]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Hoy', FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\Hoy.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Hoy_log', FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\Hoy_log.ldf' , SIZE = 2048KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
